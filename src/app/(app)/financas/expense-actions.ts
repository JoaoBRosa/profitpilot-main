...
export async function addExpenseAction(
  ...
  // O formulário pede sempre um valor positivo; para "credit" (reembolsos,
  // créditos de ads, etc.) guardamos negativo para reduzir o total de
  // despesas e refletir a receita extra no lucro real.
  const isCredit = d.category === "credit";
  const amount = isCredit ? -d.amount : d.amount;
  const signedAmountBase = isCredit ? -amountBase : amountBase;
